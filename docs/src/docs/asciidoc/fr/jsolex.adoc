...
La fenêtre liste tous les scans disponibles sur l'appareil, avec leur date d'acquisition, leur raie spectrale et leur état de traitement. Cochez les scans à traiter, choisissez un dossier de téléchargement, puis cliquez sur "Importer et traiter". JSol'Ex télécharge les fichiers `scan.ser` sélectionnés et les ouvre : un scan unique ouvre la fenêtre de traitement habituelle, tandis que plusieurs scans sont traités en lot.
