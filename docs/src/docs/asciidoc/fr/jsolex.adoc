...
Vous pouvez choisir d'appliquer un filtre d'amélioration des détails à la fin du traitement en cochant la case "aiguiser les images".
...
include::{generated-funs}/fr/functions.adoc[leveloffset=+2]
