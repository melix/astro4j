...
- *Signature* : texte libre placé en bas à gauche de l'image. Vous pouvez choisir la police (la liste déroulante affiche chaque famille dans sa propre typographie) et la taille.
