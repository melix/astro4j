...
- *Échelle des protubérances* : cercles concentriques pointillés à l'extérieur du limbe, avec des étiquettes de distance en kilomètres. Vous pouvez choisir le nombre de cercles et l'espacement entre eux.
