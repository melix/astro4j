...
- *Prominence scale*: dashed concentric circles outside the solar limb with distance labels in kilometres. You can choose the number of circles and the spacing between them.
