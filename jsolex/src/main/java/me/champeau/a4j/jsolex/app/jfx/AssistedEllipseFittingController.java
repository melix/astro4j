...
public class AssistedEllipseFittingController {
    ...
    private void setupImageView() {
        imageView = new ZoomableImageView();
    ...
    private void setupEventHandlers() {
        resetButton.setOnAction(e -> resetEllipse());
        applyButton.setOnAction(e -> applyEllipse());
     ...
     */
    public void setup(ImageWrapper32 image, Ellipse initialEllipse) {
    ...
    /**
     * Resets the ellipse to its initial state
     */
    ...
    /**
     * Updates the preview with the current ellipse
     */
    ...
    /**
     * Applies the current ellipse and closes the dialog
     */
    ...
    /**
     * Sets the callback for when the ellipse is applied
     */
            ...
            try {
                ...
                var title = fileName != null
                    ? String.format("%s - %s (%d/%d)", 
                        I18N.string(JSolEx.class, "assisted-ellipse-fitting", "assisted.ellipse.fitting"),
