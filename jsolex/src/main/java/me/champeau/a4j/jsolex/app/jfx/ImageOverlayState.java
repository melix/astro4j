...
public record ImageOverlayState(
    ...
    public ImageOverlayState withPromScaleAngle(Integer v) {
        return new ImageOverlayState(drawGlobe, drawObservationDetails, drawSolarParameters, drawEarth, drawProminenceScale, pCorrected, earthX, earthY, gridColor, obsDetailsColor, solarParamsColor, promScaleColor, promCircles, promStepKm, obsDetailsTemplate, lineThickness, drawSignature, signatureText, signatureColor, signatureFontFamily, signatureFontSize, signatureX, signatureY, obsDetailsX, obsDetailsY, solarParamsX, solarParamsY, promScaleLineThickness, drawActiveRegions, activeRegionsColor, activeRegionsBoxes, signatureFontWeight, textAreas, colorizeProfile, colorizeColor, colorizePreserveBrightness, v);
    }
    ...
    public ImageOverlayState withSignatureFontWeight(String v) {
        return new ImageOverlayState(drawGlobe, drawObservationDetails, drawSolarParameters, drawEarth, drawProminenceScale, pCorrected, earthX, earthY, gridColor, obsDetailsColor, solarParamsColor, promScaleColor, promCircles, promStepKm, obsDetailsTemplate, lineThickness, drawSignature, signatureText, signatureColor, signatureFontFamily, signatureFontSize, signatureX, signatureY, obsDetailsX, obsDetailsY, solarParamsX, solarParamsY, promScaleLineThickness, drawActiveRegions, activeRegionsColor, activeRegionsBoxes, v, textAreas, colorizeProfile, colorizeColor, colorizePreserveBrightness, promScaleAngle);
    }
    ...
    public ImageOverlayState withDrawActiveRegions(boolean v) {
        return new ImageOverlayState(drawGlobe, drawObservationDetails, drawSolarParameters, drawEarth, drawProminenceScale, pCorrected, earthX, earthY, gridColor, obsDetailsColor, solarParamsColor, promScaleColor, promCircles, promStepKm, obsDetailsTemplate, lineThickness, drawSignature, signatureText, signatureColor, signatureFontFamily, signatureFontSize, signatureX, signatureY, obsDetailsX, obsDetailsY, solarParamsX, solarParamsY, promScaleLineThickness, v, activeRegionsColor, activeRegionsBoxes, signatureFontWeight, textAreas, colorizeProfile, colorizeColor, colorizePreserveBrightness, promScaleAngle);
    }

    public ImageOverlayState withActiveRegionsColor(String c) {
        return new ImageOverlayState(drawGlobe, drawObservationDetails, drawSolarParameters, drawEarth, drawProminenceScale, pCorrected, earthX, earthY, gridColor, obsDetailsColor, solarParamsColor, promScaleColor, promCircles, promStepKm, obsDetailsTemplate, lineThickness, drawSignature, signatureText, signatureColor, signatureFontFamily, signatureFontSize, signatureX, signatureY, obsDetailsX, obsDetailsY, solarParamsX, solarParamsY, promScaleLineThickness, drawActiveRegions, c, activeRegionsBoxes, signatureFontWeight, textAreas, colorizeProfile, colorizeColor, colorizePreserveBrightness, promScaleAngle);
    }

    public ImageOverlayState withActiveRegionsBoxes(boolean v) {
        return new ImageOverlayState(drawGlobe, drawObservationDetails, drawSolarParameters, drawEarth, drawProminenceScale, pCorrected, earthX, earthY, gridColor, obsDetailsColor, solarParamsColor, promScaleColor, promCircles, promStepKm, obsDetailsTemplate, lineThickness, drawSignature, signatureText, signatureColor, signatureFontFamily, signatureFontSize, signatureX, signatureY, obsDetailsX, obsDetailsY, solarParamsX, solarParamsY, promScaleLineThickness, drawActiveRegions, activeRegionsColor, v, signatureFontWeight, textAreas, colorizeProfile, colorizeColor, colorizePreserveBrightness, promScaleAngle);
    }

    public ImageOverlayState withTextAreas(List<TextAreaOverlay> v) {
        return new ImageOverlayState(drawGlobe, drawObservationDetails, drawSolarParameters, drawEarth, drawProminenceScale, pCorrected, earthX, earthY, gridColor, obsDetailsColor, solarParamsColor, promScaleColor, promCircles, promStepKm, obsDetailsTemplate, lineThickness, drawSignature, signatureText, signatureColor, signatureFontFamily, signatureFontSize, signatureX, signatureY, obsDetailsX, obsDetailsY, solarParamsX, solarParamsY, promScaleLineThickness, drawActiveRegions, activeRegionsColor, activeRegionsBoxes, signatureFontWeight, v, colorizeProfile, colorizeColor, colorizePreserveBrightness, promScaleAngle);
    }

    public ImageOverlayState withColorizeProfile(String v) {
        return new ImageOverlayState(drawGlobe, drawObservationDetails, drawSolarParameters, drawEarth, drawProminenceScale, pCorrected, earthX, earthY, gridColor, obsDetailsColor, solarParamsColor, promScaleColor, promCircles, promStepKm, obsDetailsTemplate, lineThickness, drawSignature, signatureText, signatureColor, signatureFontFamily, signatureFontSize, signatureX, signatureY, obsDetailsX, obsDetailsY, solarParamsX, solarParamsY, promScaleLineThickness, drawActiveRegions, activeRegionsColor, activeRegionsBoxes, signatureFontWeight, textAreas, v, null, colorizePreserveBrightness, promScaleAngle);
    }

    public ImageOverlayState withColorizeColor(String v) {
        return new ImageOverlayState(drawGlobe, drawObservationDetails, drawSolarParameters, drawEarth, drawProminenceScale, pCorrected, earthX, earthY, gridColor, obsDetailsColor, solarParamsColor, promScaleColor, promCircles, promStepKm, obsDetailsTemplate, lineThickness, drawSignature, signatureText, signatureColor, signatureFontFamily, signatureFontSize, signatureX, signatureY, obsDetailsX, obsDetailsY, solarParamsX, solarParamsY, promScaleLineThickness, drawActiveRegions, activeRegionsColor, activeRegionsBoxes, signatureFontWeight, textAreas, null, v, colorizePreserveBrightness, promScaleAngle);
    }

    public ImageOverlayState withColorizePreserveBrightness(boolean v) {
        return new ImageOverlayState(drawGlobe, drawObservationDetails, drawSolarParameters, drawEarth, drawProminenceScale, pCorrected, earthX, earthY, gridColor, obsDetailsColor, solarParamsColor, promScaleColor, promCircles, promStepKm, obsDetailsTemplate, lineThickness, drawSignature, signatureText, signatureColor, signatureFontFamily, signatureFontSize, signatureX, signatureY, obsDetailsX, obsDetailsY, solarParamsX, solarParamsY, promScaleLineThickness, drawActiveRegions, activeRegionsColor, activeRegionsBoxes, signatureFontWeight, textAreas, colorizeProfile, colorizeColor, v, promScaleAngle);
    }

    public ImageOverlayState withoutColorize() {
        return new ImageOverlayState(drawGlobe, drawObservationDetails, drawSolarParameters, drawEarth, drawProminenceScale, pCorrected, earthX, earthY, gridColor, obsDetailsColor, solarParamsColor, promScaleColor, promCircles, promStepKm, obsDetailsTemplate, lineThickness, drawSignature, signatureText, signatureColor, signatureFontFamily, signatureFontSize, signatureX, signatureY, obsDetailsX, obsDetailsY, solarParamsX, solarParamsY, promScaleLineThickness, drawActiveRegions, activeRegionsColor, activeRegionsBoxes, signatureFontWeight, textAreas, null, null, colorizePreserveBrightness, promScaleAngle);
    }
