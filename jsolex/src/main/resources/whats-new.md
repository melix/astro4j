...
- Scans acquired on a SunScan device can now be discovered and imported directly from the File menu, with the SunScan instrument and camera applied automatically.
