...
- Identification of spectral lines now includes telluric lines, improving accuracy.
...
- JSol'Ex is now available in Chinese. Contributed by [icelin](https://github.com/nuan-xing).
