...
final class VectorizedDoubleFFT implements FastFourierTransform {
    ...
    VectorizedDoubleFFT(double[] real, double[] imaginary) {
        this.dataR = real;
    ...
    public void inverseTransform() {
        ...
        for (; i < upperBound; i += SPECIES.length()) {
            var vr = DoubleVector.fromArray(SPECIES, dataR, i);
            var vi = DoubleVector.fromArray(SPECIES, dataI, i);
    ...
    private static void transformInPlace(double[] dataR, double[] dataI, boolean inverse) {
    ...
    private static void radix2Butterfly(double[] dataR, double[] dataI) {
    ...
    private static void radix2Stages(double[] dataR, double[] dataI, int n, boolean inverse) {
        if (inverse) {
    ...
    private static void radix2StagesForward(double[] dataR, double[] dataI, int n) {
        int lastN0 = 4;
        int lastLogN0 = 2;
    ...
    private static void radix2StagesInverse(double[] dataR, double[] dataI, int n) {
        int lastN0 = 4;
        int lastLogN0 = 2;
    ...
    private static void radix2Stage(double[] dataR,
                                    double[] dataI,
                                    int n,
                                    int n0,
                                    int lastN0,
                                    double wSubN0R,
                                    double wSubN0I) {
        double[] twR = new double[lastN0];
        double[] twI = new double[lastN0];
        double wrr = 1.0;
        double wri = 0.0;
        for (int k = 0; k < lastN0; k++) {
            twR[k] = wrr;
            twI[k] = wri;
            double nr = wrr * wSubN0R - wri * wSubN0I;
            double ni = wrr * wSubN0I + wri * wSubN0R;
            wrr = nr;
            wri = ni;
        }
        ...
        for (int destEvenStartIndex = 0; destEvenStartIndex < n; destEvenStartIndex += n0) {
            ...
            for (; r < loopBound; r += laneCount) {
                var grR = DoubleVector.fromArray(SPECIES, dataR, destEvenStartIndex + r);
                var grI = DoubleVector.fromArray(SPECIES, dataI, destEvenStartIndex + r);
                var hrR = DoubleVector.fromArray(SPECIES, dataR, destOddStartIndex + r);
                var hrI = DoubleVector.fromArray(SPECIES, dataI, destOddStartIndex + r);
                var twvr = DoubleVector.fromArray(SPECIES, twR, r);
                var twvi = DoubleVector.fromArray(SPECIES, twI, r);
            ...
            for (; r < lastN0; r++) {
                ...
                double tempR = twr * hrR - twi * hrI;
                double tempI = twr * hrI + twi * hrR;
    ...
    private static void radix4Stage(double[] dataR, double[] dataI, int n, boolean inverse) {
        if (inverse) {
    ...
    private static void radix4ButterflyForward(double[] dataR, double[] dataI, int i0) {
        final int i1 = i0 + 1;
        final int i2 = i0 + 2;
        final int i3 = i0 + 3;
    ...
    private static void radix4ButterflyInverse(double[] dataR, double[] dataI, int i0) {
        final int i1 = i0 + 1;
        final int i2 = i0 + 2;
        final int i3 = i0 + 3;
