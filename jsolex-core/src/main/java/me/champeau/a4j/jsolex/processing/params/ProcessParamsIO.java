...
public abstract class ProcessParamsIO {
    ...
    public static ProcessParams createNewDefaults() {
        return new ProcessParams(
                ...
                new GeometryParams(null, null, false, false, false, false, RotationKind.NONE, AutocropMode.RADIUS_1_2, null, DeconvolutionMode.NONE, null, false, null, false, null, false, EllipseFittingMode.AUTOMATIC, null, null),
