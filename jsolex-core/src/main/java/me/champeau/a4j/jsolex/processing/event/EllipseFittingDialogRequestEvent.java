 ...
 */
public final class EllipseFittingDialogRequestEvent extends ProcessingEvent<EllipseFittingDialogRequestEvent.Payload> {
    ...
    public EllipseFittingDialogRequestEvent(ImageWrapper32 image, Ellipse initialEllipse, CompletableFuture<Ellipse> resultFuture) {
